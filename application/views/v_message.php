...
<body>
	  	...
	  	<div class="jm-container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="active"><a class="jm-link" href="Message">Message</a></li>
					...
					<li><a class="jm-idioma" href="Message"><span>English</span></a></li>
					<li><a class="jm-idioma" href="Message_jp"><span>Japanesse</span></a></li>
				</ul>
			</div>
	  	</div>
	</nav>
	<section class="jm-section">
		<div class="jm-container">
			<div class="jm-title">
				<h2>Message</h2>
				<p>Passion never make our Journey ended Perpetual.</p>
				<span>Passion will never end our journey.</span>
				<span>The "Eye" refers to our battery brand, "Cambria Eye".</span>
			</div>
		</div>
	</section>
	<section>
