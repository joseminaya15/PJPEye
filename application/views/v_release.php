...
<body>
	  	...
	  	<div class="jm-container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="active"><a class="jm-link" href="Release">Press release</a></li>
					<li><a class="jm-link" href="Next">Laboratory6</a></li>
					<li><a class="jm-link" href="Contact">Contact</a></li>
					<li><a class="jm-idioma" href="Release"><span>English</span></a></li>
					<li><a class="jm-idioma" href="Release_jp"><span>Japanesse</span></a></li>
				</ul>
			</div>
	  	</div>
	</nav>
	<section>
		<div class="jarallax">
			...
			<img class="jarallax-img" src="public/img/fondo/fondo4.jpg" alt="">
			<div class="jm-contenido--jarallax scrollflow -slide-top -opacity">
				<div class="jm-text--parallax">
					<h2>Press Release</h2>
					<div class="jm-grid jm-grid--release">
						<div class="jm-card--release">
							<div class="jm_title">
								<p>August 13, 2017</p>
								<h2>Partial Business Transfer Notification</h2>
							</div>
							<div class="jm_menu">
