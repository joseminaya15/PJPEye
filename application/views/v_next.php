	  	...
	  	<div class="jm-container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="active"><a class="jm-link" href="Next">Laboratory6</a></li>
					<li><a class="jm-link" href="Contact">Contact</a></li>
					<li><a class="jm-idioma" href="Next"><span>English</span></a></li>
					<li><a class="jm-idioma" href="Next_jp"><span>Japanesse</span></a></li>
				</ul>
			</div>
	  	</div>
	</nav>
	<section class="jm-section jm-gris jm-height jm-flex">
		<div class="jm-container">
			<div class="jm-title">
				<h2>Coming soon</h2>
			</div>
